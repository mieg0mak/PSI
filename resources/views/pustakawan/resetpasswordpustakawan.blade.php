...
@section('breadcrump')
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Dashboard Pustakawan</li>
          </ol>
@stop
@section('content')
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Ganti Password Pustakawan </h3>
                </div><!-- /.box-header -->
                ...
                <div class="box box-primary">   
                  ...
                  <div class="box-body no-padding">
                      <form id="formResetPassword" class="form-horizontal" role="form" method="POST" action="{{ route('reset.password.pustakawan') }}">
