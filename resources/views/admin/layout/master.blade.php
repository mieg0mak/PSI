...
<html>
  <head>
    ...
    <link href="{{URL::asset('auth/images/s_logo.ico') }}" rel="SHORTCUT ICON" />
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      @elseif(Auth::user()->level==4)
        @include('admin.include.sidebarkepsek')
      @elseif(Auth::user()->level==5)
        @include('admin.include.sidebarguru')
      @elseif(Auth::user()->level==6)
        @include('admin.include.sidebarpustakawan')
      @endif
