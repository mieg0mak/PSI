                     ...
                     <?php foreach ($listAccountDosen as $itemAccount):  ?>
                      <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-success btn-flat btn-sm" onClick="tampilModal('{{$itemAccount->dsnNip}}','{{$itemAccount->dsnNama}}')" id="register{{{$itemAccount->dsnNip}}}" title="Register"><i class="fa fa-plus"></i></a>
                            @else
                           
                            <a class="btn btn-danger btn-flat btn-sm" href="{{{ URL::to('accountdosen/'.$itemAccount->id.'/hapus') }}}" title="Hapus Akun"><i class="fa fa-trash"> Unreg </i></span>
                            </a> 
                            @endif
